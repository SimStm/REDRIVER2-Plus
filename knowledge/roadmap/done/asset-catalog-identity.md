...
Order 04. Incorporate schema decisions from [03](texture-manifest-merge.md). Provides the shared contract for [05](../planned/object-texture-batch-export.md), [06](inspector-selection-coverage.md) and [09](../planned/model-export-import-roundtrip.md).
