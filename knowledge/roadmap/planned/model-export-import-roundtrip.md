...
Order 09 after [04](asset-catalog-identity.md), [05](object-texture-batch-export.md), [06](inspector-selection-coverage.md) and the format decision in [08](modding-toolchain-integration.md). Export-only milestones may precede import.
